...
<img src="https://github.com/spacetelescope/mast-blog/blob/main/assets/img/posts/20241022/cubeviz_for_blog.png" alt="Cubeviz interface showing the cube of object NGC7469 as part of 
  ...
  shows the velocity map of the Paschen-alpha line. The bottom viewer shows 
...
left viewer shows the flux cube at 2.13 micron and the three spatial subsets used for the analysis. The top right viewer shows 
the calculated velocity map of the Paschen-alpha line obtained with the Moment Map plugin. The bottom viewer shows the spectra extracted 
